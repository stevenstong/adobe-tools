//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/external/afl/includes/AAllocator.h $
//  
...
public:
	...
	AFLAllocator(const AFLAllocator& src) throw() {
	}
	template <class U>
	AFLAllocator(const AFLAllocator<U> &src) throw() {
	}
	~AFLAllocator() throw() {
	}
...
bool operator==(const AFLAllocator<T1>&, const AFLAllocator<T2>&) throw() {
	return true;
}
template <class T1, class T2>
bool operator!=(const AFLAllocator<T1>&, const AFLAllocator<T2>&) throw() {
