...
namespace boost { namespace numeric { namespace ublas {
    ...
    public:
        ...
        BOOST_UBLAS_INLINE
        const_iterator1 find1 (int rank, size_type i, size_type j) const {
            const_iterator11_type it11 (e1_.find1 (rank, static_cast<typename E1::size_type>(i), static_cast<typename E1::size_type>(j)));
            const_iterator11_type it11_end (e1_.find1 (rank, static_cast<typename E1::size_type>(size1 ()), static_cast<typename E1::size_type>(j)));
        ...
        BOOST_UBLAS_INLINE
        const_iterator2 find2 (int rank, size_type i, size_type j) const {
            const_iterator12_type it12 (e1_.find2 (rank, static_cast<typename E1::size_type>(i), static_cast<typename E1::size_type>(j)));
            const_iterator12_type it12_end (e1_.find2 (rank, static_cast<typename E1::size_type>(i), static_cast<typename E1::size_type>(size2 ())));
