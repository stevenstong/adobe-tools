...
DECLARE_PMID(kClassIDSpace, kPublishOnlineHyperlinkTextWidgetBoss,		kWidgetPrefix + 279)
//gap
...
DECLARE_PMID(kImplementationIDSpace, kPublishOnlineHyperlinkTextEHImpl, kWidgetPrefix + 63)
