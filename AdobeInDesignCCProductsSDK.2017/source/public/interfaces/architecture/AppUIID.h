...
DECLARE_PMID(kClassIDSpace, kSetShowEnhancedFileOpenPreferenceCmdBoss, kAppUIPrefix + 95)
...
DECLARE_PMID(kClassIDSpace, kHTMlPublishFTUENewDocResponderBoss, kAppUIPrefix + 220)
DECLARE_PMID(kClassIDSpace, kHTMlPublishFTUEOpenDocResponderBoss, kAppUIPrefix + 221)
DECLARE_PMID(kClassIDSpace, kHTMlPublishFTUECloseDocResponderBoss, kAppUIPrefix + 222)
DECLARE_PMID(kClassIDSpace, kHTMlPublishFTUEExportResponderBoss, kAppUIPrefix + 223)
DECLARE_PMID(kClassIDSpace, kHTMlPublishFTUEPrintResponderBoss, kAppUIPrefix + 224)
...
DECLARE_PMID(kInterfaceIDSpace, IID_IHTMLPUBLISHFTUEMANAGER, kAppUIPrefix + 60)
...
DECLARE_PMID(kInterfaceIDSpace, IID_IHTMLPUBLISHFTUEAPPRESUMEOBSERVER, kAppUIPrefix + 100)
...
DECLARE_PMID(kImplementationIDSpace, kPublishHTMLToastPopupObserverImpl, kAppUIPrefix + 63)
DECLARE_PMID(kImplementationIDSpace, kMenuSetSaveAsButtonObserverImpl, kAppUIPrefix + 64)
DECLARE_PMID(kImplementationIDSpace, kPublishHTMLToastPopupControllerImpl, kAppUIPrefix + 65)
...
DECLARE_PMID(kImplementationIDSpace, kHTMLPublishFTUEManagerImpl, kAppUIPrefix + 69)
DECLARE_PMID(kImplementationIDSpace, kPublishHTMLToastCloseButtonViewImpl, kAppUIPrefix + 70)
DECLARE_PMID(kImplementationIDSpace, kPublishHTMLToastPopupPositionHelperImpl, kAppUIPrefix + 71)
DECLARE_PMID(kImplementationIDSpace, kUIFeedbackUtilsImpl, kAppUIPrefix + 72)
DECLARE_PMID(kImplementationIDSpace, kPublishHTMLToastPopupOverridenEHImpl, kAppUIPrefix + 73)
DECLARE_PMID(kImplementationIDSpace, kHTMLPublishFTUEObserverImpl, kAppUIPrefix + 74)
DECLARE_PMID(kImplementationIDSpace, kHTMLPublishFTUECheckDocResponderImpl, kAppUIPrefix + 75)
...
DECLARE_PMID(kImplementationIDSpace, kSetShowEnhancedFileOpenPreferenceCmdImpl, kAppUIPrefix2 + 34)
...
DECLARE_PMID(kActionIDSpace, kPaletteWorkspaceCCXOpenWorkspaceActionID, kAppUIPrefix + 79)  // Currently used only for positioning
