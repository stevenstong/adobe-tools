...
DECLARE_PMID(kInterfaceIDSpace, IID_IPUBLISHFTUEHOVERCHANGE, kImportExportUIPrefix + 28)
...
DECLARE_PMID(kImplementationIDSpace, kPublishFTUESaveConditionsCmdImpl,				kImportExportUIPrefix + 150)
