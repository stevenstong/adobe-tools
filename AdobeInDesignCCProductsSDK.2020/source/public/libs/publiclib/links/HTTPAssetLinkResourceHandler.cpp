//========================================================================================
//  
//  $File: //depot/devtech/15.0/plugin/source/public/libs/publiclib/links/HTTPAssetLinkResourceHandler.cpp $
//  
...
IPMStream* HTTPAssetLinkResourceHandler::CreateResourceReadStream(const UIDRef& ref, const URI& inUri) const
{
	...
	std::shared_ptr<IHTTPLinkCachedAssetEntry> cachedAssetEntry = GetCachedAssetEntry(ref, HTTPLinkSubsystemTypes::kAssetDownloadMode_Sync, kTrue /*shouldDownload*/);
