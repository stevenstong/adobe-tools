//========================================================================================
//  
//  $File: //depot/devtech/15.0/plugin/source/public/includes/IconRsrcDefs.h $
//  
//  Owner:
//  
//  $Author: pmbuilder $
...
// we need to update only description and MAC OS Type, no change on Win. Icons are same as CC
#if (defined(INDESIGNPACKAGE) || defined(INCOPYPACKAGE))
#define kR12DocumentDescription	"InDesign\U00AE 2020.0 Document"
...
// we need to update only description and MAC OS Type, no change on Win. Icons are same as CC
#ifdef INDESIGNPACKAGE
#define kR12TemplateDescription	"InDesign\U00AE 2020.0 Template"
...
// we need to update only description and MAC OS Type, no change on Win. Icons are same as CC
#ifdef INDESIGNPACKAGE
#define kR12BookDescription		"InDesign\U00AE 2020.0 Book"
