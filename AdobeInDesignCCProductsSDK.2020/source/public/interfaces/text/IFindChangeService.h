//========================================================================================
//  
//  $File: //depot/devtech/15.0/plugin/source/public/interfaces/text/IFindChangeService.h $
//  
//  Owner: Wai Cheuk
//  
//  $Author: pmbuilder $
...
public:
	...
	*/
	...
	Search for color in object and text
	@return	FindChangeResult	returns kFailure if error
	*/
	virtual FindChangeResult SearchColor(bool16 initializeWalker = kFalse) = 0;

	/**
    Internal use. Do not call.
	Replace for color in object and text
	@return	FindChangeResult	returns kFailure if error
	*/
	...
	/**
    Internal use. Do not call.
	Replace All color in object and text
	@return	FindChangeResult	returns kFailure if error
	*/
	virtual FindChangeResult ReplaceAllColor(int32* foundCount, int32* fullyChangedCount, int32* partiallyChangedCount, bool16 initializeWalker = kFalse) = 0;

	/**
    Internal use. Do not call.
	Replace color in object and text and Find Next
	@return	FindChangeResult	returns kFailure if error
	*/
	virtual FindChangeResult ReplaceAndSearchColor(bool16 initializeWalker = kFalse) = 0;
