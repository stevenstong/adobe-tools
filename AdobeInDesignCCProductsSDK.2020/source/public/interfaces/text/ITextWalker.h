//========================================================================================
//  
//  $File: //depot/devtech/15.0/plugin/source/public/interfaces/text/ITextWalker.h $
//  
	...
	*/
	...
	/**
     Internal use. Do not call.
		Should we update walker text range

		@return bool16
	*/
	virtual bool16   ShouldUpdateWalkerTextRange() { return kTrue; };

	/**
    Internal use. Do not call.
	Is Table Color Attribute Found

	@return bool16
	*/
	virtual bool16   IsTableColorAttributeFound(GridArea& gridArea) { return kFalse; };
};
