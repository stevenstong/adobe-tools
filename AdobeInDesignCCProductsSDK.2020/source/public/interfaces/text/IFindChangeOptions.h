//========================================================================================
//  
//  $File: //depot/devtech/15.0/plugin/source/public/interfaces/text/IFindChangeOptions.h $
//  
//  Owner: Wai Cheuk
//  
//  $Author: pmbuilder $
...
public:
	...
	/**
	 Internal use. Do not call.
	Enum for distinguishing between Color Search Type
	*/
	...
	*/
    ...
    /**
     Internal use. Do not call.
     Gets the Find Color Search Type
     @return IFindChangeOptions::SearchType
     @see IFindChangeOptions::SearchType
     @see IFindChangeOptions::SetSearchType
     */
    virtual IFindChangeOptions::ColorSearchType GetFindColorSearchType() const = 0 ;
    
    /**
     Internal use. Do not call.
     Sets the Find Color Search Type
     @param mode is of type IFindChangeOptions::SearchType specifying the type of Find/Change
     @see IFindChangeOptions::SearchType
     @see IFindChangeOptions::GetSearchType
     */
    virtual void SetFindColorSearchType(IFindChangeOptions::ColorSearchType) = 0;
    
    /**
     Internal use. Do not call.
     Gets the Replace Color Search Type
     @return IFindChangeOptions::SearchType
     @see IFindChangeOptions::SearchType
     @see IFindChangeOptions::SetSearchType
     */
    virtual IFindChangeOptions::ColorSearchType GetReplaceColorSearchType() const = 0 ;
    
    /**
     Internal use. Do not call.
     Sets the Replace Color Search Type
     @param mode is of type IFindChangeOptions::SearchType specifying the type of Find/Change
     @see IFindChangeOptions::SearchType
     @see IFindChangeOptions::GetSearchType
     */
    virtual void SetReplaceColorSearchType(IFindChangeOptions::ColorSearchType) = 0;
    
    /**
     Internal use. Do not call.
     Get StrokeFill CheckBox is Checked or Not
     */
    virtual bool16 GetColorStrokeFillChecked() const = 0 ;
    
    /**
     Internal use. Do not call.
     Set StrokeFill CheckBox Checked
     */
    virtual void SetColorStrokeFillChecked(bool16 checked) = 0 ;
