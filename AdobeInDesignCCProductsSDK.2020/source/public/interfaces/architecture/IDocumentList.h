//========================================================================================
//  
//  $File: //depot/devtech/15.0/plugin/source/public/interfaces/architecture/IDocumentList.h $
//  
//  Owner: Robin_Briggs
//  
//  $Author: pmbuilder $
...
public:
	...
	/**	 All arguments are same as OpenDoc. Only two extra parameters are added. bOpenPreTransVersion and bIsFirstPass
	@param bOpenPreTransVersion indicates whether to use pre transaction master page to open this document
	@param bIsFirstPass indicates whether this is first call to function or second recursive call (done for conversion of document)
	@return IDocument opened document
	*/
	virtual IDocument * OpenDocument(const IDFile& whatFile, IDataBase::ProtectionLevel protection, bool16 bOpenOriginal = true, UIFlags alertMissingPlugIns = kAskMissing, bool16 bUseLockFile = kTrue, IDocument::UndoSupport undoSupport = IDocument::kFullUndoSupport, bool bOpenPreTransVersion = false, bool bIsFirstPass = true) = 0;
