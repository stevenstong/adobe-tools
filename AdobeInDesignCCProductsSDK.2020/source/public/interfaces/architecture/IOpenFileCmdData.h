//========================================================================================
//  
//  $File: //depot/devtech/15.0/plugin/source/public/interfaces/architecture/IOpenFileCmdData.h $
//  
//  Owner: Roey Horns
//  
//  $Author: pmbuilder $
...
public:
	...
	*/
	...
	/**
		Set the option whether you want to open pre-transaction version of file.
	*/
	virtual void SetOpenPreTransVersion(bool flag) = 0;

	/**
		Get the option whether you want to open pre-transaction version of file.
	*/
	virtual bool GetOpenPreTransVersion() const = 0;
};
