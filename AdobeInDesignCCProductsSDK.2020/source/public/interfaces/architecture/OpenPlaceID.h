//========================================================================================
//  
//  $File: //depot/devtech/15.0/plugin/source/public/interfaces/architecture/OpenPlaceID.h $
//  
...
DECLARE_PMID(kInterfaceIDSpace, IID_IOPENPRETRANSVERSION, kOpenPlacePrefix + 6)
