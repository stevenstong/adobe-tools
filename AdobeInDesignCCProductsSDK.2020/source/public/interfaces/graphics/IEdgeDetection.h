//========================================================================================
//  
//  $File: //depot/devtech/15.0/plugin/source/public/interfaces/graphics/IEdgeDetection.h $
//  
//  Owner: dstephen
//  
//  $Author: pmbuilder $
	...
	*/
	virtual ErrorCode MaskToPolygon
		(
			...
			const char *deepCutMask = NULL,		// The image
			uint32 deepCutSize = 0				//Size of Image String
		) const = 0;
