...
{
	UIDRef endnoteStoryRef(modelRef.GetDataBase(), kInvalidUID);
	Utils<IEndnoteUtils> endnoteUtils;
	bool isEndnoteAnchorOrEndnoteStory = endnoteUtils->IsEndnoteAnchorOrEndnoteStory(modelRef, endnoteStoryRef);
