...
//-------------------------------------------------------------------------------------
		/**	Contruct an identity matrix:
			...
			[ 0 0 1]
		*/
		PUBLIC_DECL constexpr PMMatrix() noexcept
		...
		/**	Contruct a matrix with a, b, c, d, e, f as initial values:
			...
			[ e f 1]
		*/
 		PUBLIC_DECL constexpr PMMatrix( PMReal a, PMReal b, PMReal c, PMReal d, PMReal e, PMReal f) noexcept
		...
		*/
		PUBLIC_DECL constexpr PMMatrix(const PMMatrix &m) noexcept = default;
		PUBLIC_DECL constexpr PMMatrix(PMMatrix &&m) noexcept = default;
		...
		*/
		PUBLIC_DECL PMMatrix& operator=(const PMMatrix &m) noexcept = default;
		PUBLIC_DECL PMMatrix& operator=(PMMatrix &&m) noexcept = default;
