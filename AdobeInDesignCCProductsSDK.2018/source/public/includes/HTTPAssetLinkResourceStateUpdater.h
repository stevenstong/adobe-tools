//========================================================================================
//  
//  $File: //depot/devtech/nevis/plugin/source/public/includes/HTTPAssetLinkResourceStateUpdater.h $
//  
//  Owner: Sanyam Jain
//  
//  $Author: pmbuilder $
...
private:
	...
	static ILinkResource::ResourceState GetStateForInAccessibleLinks() { return ILinkResource::kInaccessible; }	
