...
// we need to update only description and MAC OS Type, no change on Win. Icons are same as CC
#if (defined(INDESIGNPACKAGE) || defined(INCOPYPACKAGE))
#define kR12DocumentDescription	"InDesign\U00AE CC 2018.0 Document"
...
// we need to update only description and MAC OS Type, no change on Win. Icons are same as CC
#ifdef INDESIGNPACKAGE
#define kR12TemplateDescription	"InDesign\U00AE CC 2018.0 Template"
...
// we need to update only description and MAC OS Type, no change on Win. Icons are same as CC
#ifdef INDESIGNPACKAGE
#define kR12BookDescription		"InDesign\U00AE CC 2018.0 Book"
